        ...
        <div className="animate-slide-up rounded-xl border border-gold-500/20 bg-gold-500/[0.04] p-4">
          <div className="mb-2 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              {loading && (
                <button onClick={handleCancel} className="rounded p-1 active:opacity-70" aria-label="Stop">
          ...
          <p className="mt-3 text-[10px] text-muted">
            AI can make mistakes — weigh answers against Scripture and your church family.
          </p>
        </div>
      )}
    </div>
